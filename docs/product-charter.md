...
Working hypothesis: these organizations share enough adoption patterns to benefit from a common public framework while still needing context-specific guidance.
...
- The framework focuses on one defined team and one defined workflow at a time.
- The framework should not assign one simplistic organization-wide maturity score.
- Workflow and program logic come before tools or vendors.
- Governance, management ownership, role-based training, evidence, equity, and institutional memory are part of adoption.
- The framework should support self-service, guided, facilitated, and specialist-supported use.
...
- Starting with one team and one workflow will be more useful than beginning with a broad organization-wide score.
- Workflow and program logic are better starting points than tools, vendors, or generic AI literacy.
- A ninety-day timebox may be useful for planning and momentum, but it should not be treated as a guaranteed implementation period.
- Evidence requirements should scale with consequence and risk.
- Sustained AI adoption requires governance, management ownership, role-based training, equity, and institutional memory alongside technical experimentation.
...
When a statement cannot be classified, it should be softened, removed, or moved to the appropriate planning context.
